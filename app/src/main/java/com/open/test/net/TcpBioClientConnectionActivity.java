...
import com.open.net.client.impl.tcp.bio.TcpBioClient;
...
public class TcpBioClientConnectionActivity extends Activity {
	...
	private TcpBioClient mClient =null;
	...
	private void initView()
	{
		...
		mClient = new TcpBioClient(mMessageProcessor,mConnectResultListener);
